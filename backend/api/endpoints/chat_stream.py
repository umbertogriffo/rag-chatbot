...
from api.deps import ChatHistoryDep, LLMClientDep, VectorDatabaseDep
...
async def chat_stream(
    websocket: WebSocket, llm_client: LLMClientDep, chat_history: ChatHistoryDep, index: VectorDatabaseDep
):
