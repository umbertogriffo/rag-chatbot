...
class ContextSynthesisStrategy:
    ...
    def generate_response_cr(
            self, retrieved_contents, question
    ):
        """
    ...
    def combine_results(
        ...
        for idx in range(0, len(texts), num_children):
            ...
            fmt_qa_prompt = self.llm.generate_ctx_prompt(question=question, context=context)
            combined_response = self.llm.stream_answer(fmt_qa_prompt, max_new_tokens=512)
        ...
        if len(new_texts) == 1:
            ...
            return self.combine_results(
                new_texts, question, num_children=num_children
            )
...
class Conversation:
    ...
    def answer(self, question: str, retrieved_contents) -> str:
        ...
        answer, fmt_prompts = strategy.generate_response_cr(retrieved_contents, question)
