...
def stream_response(llm: LamaCppClient, user_input: str, chat_history: ChatHistory, max_new_tokens: int) -> str:
    """
    Streams a response from the language model (LLM) to the user input, updating the UI in real-time.
    ...
    Returns:
        str: The full response generated by the LLM.
