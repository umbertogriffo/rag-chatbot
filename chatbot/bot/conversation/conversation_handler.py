...
def refine_question(llm: OpenRouterClient, question: str, chat_history: ChatHistory, max_new_tokens: int = 128) -> str:
    """
...
def answer(llm: OpenRouterClient, question: str, chat_history: ChatHistory, max_new_tokens: int = 512) -> Any:
    """
